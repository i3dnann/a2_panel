...
import { Activity, BellRing, CheckCircle2, ClipboardList, Eye, Gavel, Lock, LogIn, Package, Radio, ShieldCheck, User, Users, XCircle } from "lucide-react";
...
const panelFunctions = [
  ...
  { title: "Staff control", detail: "Owner-controlled staff roles, permissions, Admin, and God access.", icon: ShieldCheck }
];
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#060708] px-4 py-5 text-white">
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-2.5rem)] w-full max-w-[1440px] gap-5">
        <header className="flex w-full max-w-[calc(100vw-2rem)] items-center justify-between gap-4 rounded-md border border-white/10 bg-[#080b0f]/82 px-3 py-3 backdrop-blur-xl">
        ...
        <main className="grid w-full max-w-[calc(100vw-2rem)] min-w-0 items-stretch gap-5 xl:max-w-none xl:grid-cols-[minmax(0,1fr)_430px]">
          <section className="grid min-w-0 gap-5">
            <motion.div
              ...
              className="grid w-full max-w-full min-w-0 gap-5 rounded-md border border-white/10 bg-[#0a0e12]/90 p-5 shadow-panel backdrop-blur-xl lg:grid-cols-[0.95fr_1.05fr]"
            >
              <div className="flex min-h-[420px] min-w-0 flex-col justify-between gap-6">
                <div>
                  <h1 className="max-w-2xl text-4xl font-black leading-[1.04] tracking-normal text-white md:text-6xl">A2 Panel</h1>
              ...
              <motion.div
                ...
                className="relative min-w-0 overflow-hidden rounded-md border border-a2-green/25 bg-[#0a0f12] p-4 shadow-[0_24px_80px_rgba(0,0,0,0.34)]"
              >
            ...
            <section className="grid gap-3 md:grid-cols-2 2xl:grid-cols-3">
              {panelFunctions.map((item, index) => (
                <motion.div
                  ...
                  className="rounded-md border border-white/10 bg-[#0a0e12]/90 p-4 transition hover:border-a2-green/25"
                >
                  <div className="mb-3 grid h-10 w-10 place-items-center rounded-md border border-a2-green/20 bg-a2-green/10 text-a2-green">
          ...
          <motion.form
            ...
            className="a2-glass sticky top-5 grid h-fit min-w-0 w-full max-w-full gap-5 rounded-md p-6 shadow-panel"
            onSubmit={submit}
          >
            <div>
